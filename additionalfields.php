 ...
 * !!                                                                         !!
 * !! Making any changes to this file may cause the Arsys WHMCS Module  !!
 * !! to stop working or register invalid domains/information.                 !!
 * !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 *
 * Automatically adding fields needed to register domains with Arsys/MrDomain.
 *
 ...
 * //...file contents
 *
 * include('../modules/registrars/arsys/additionaldomainfields.php');
 *
 * ?>
 *
 * API version 0.9.x
