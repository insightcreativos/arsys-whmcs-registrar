...
namespace WHMCS\Module\Registrar\Arsys;

use WHMCS\Module\Registrar\Arsys\Services\Contracts\WHMCSService_Interface;
use WHMCS\Module\Registrar\Arsys\Services\Contracts\APIService_Interface;
use WHMCS\Module\Registrar\Arsys\Services\Contracts\ImportService_Interface;
use WHMCS\Module\Registrar\Arsys\Services\WHMCS_Service;
...
class App {
	 ...
	 * @param array $params
	 *
	 * @staticvar App $instance The *Singleton* instances of this class.
	 * @return App The *Singleton* instance.
	 * @since 1.0.0
	 *
	 */
	public static function get_instance( array $params = [] ): ?App {
	 ...
	 *
	 * @param WHMCS\Module\Registrar\Arsys\Services\Contracts\WHMCSService_Interface $service
	 *
	 * @return void
	 */
	 ...
	 *
	 * @param WHMCS\Module\Registrar\Arsys\Services\Contracts\APIService_Interface $service
	 *
	 * @return void
	 */
	 ...
	 *
	 * @param WHMCS\Module\Registrar\Arsys\Services\Contracts\ImportService_Interface $service
	 *
	 * @return void
	 */
	...
	public function dispatchAction( $action, array $params = [] ) {
		...
		$className = '\WHMCS\Module\Registrar\Arsys\Actions\\' . $action;
