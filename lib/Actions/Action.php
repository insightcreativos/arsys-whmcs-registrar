...
class Action {
	...
	protected function getVATNumber() {
		 ...
		 */
		if ( array_key_exists( 'ID Form Number',
				$this->params['additionalfields'] ) && strlen( $this->params['additionalfields']['ID Form Number'] ) > 0 ) {
		 ...
		 */
		if ( array_key_exists( 'VAT Number',
				$this->params['additionalfields'] ) && strlen( $this->params['additionalfields']['VAT Number'] ) > 0 ) {
		...
		$tldMap = [
			$this->params['additionalfields']['Company ID Number'] => [
				'co.uk',
				'net.uk',
				'org.uk',
				'me.uk',
			...
			$this->params['additionalfields']['RCB Singapore ID']  => [
				'sg',
				'com.sg',
				'edu.sg',
				'net.sg',
			...
			$this->params['additionalfields']['Registrant ID']     => [
				'com.au',
				'net.au',
				'org.au',
				'asn.aun',
