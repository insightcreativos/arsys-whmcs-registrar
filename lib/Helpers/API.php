...
namespace WHMCS\Module\Registrar\Arsys\Helpers;
...
class API {
	...
	/**
	 * Returns Arsys API path
	 *
	 * @return string
	 */
	public static function getApiPath() {
		return implode( DIRECTORY_SEPARATOR, [ ROOTDIR, 'includes', 'arsys', 'sdk' ] );
	}

	/**
	 * Returns composer.json path from Arsys API
	 *
	 * @return string
	 */
	...
	/**
	 * Returns autoloader.php from Arsys API
	 *
	 * @return string
	 */
	...
	/**
	 * Returns if Arsys API is installed
	 *
	 * @return bool
	 */
	...
	/**
	 * Returns if Arsys API composer.json exists
	 *
	 * @return bool
	 */
	...
	/**
	 * Returns if Arsys API autoloader.php exists
	 *
	 * @return bool
	 */
	...
	/**
	 * Instantiates Arsys API and returns instance
	 *
	...
	public function getConnection() {
		if ( is_null( $this->connection ) ) {
			...
			$this->connection = new \Arsys\API\API( $options );
		}
